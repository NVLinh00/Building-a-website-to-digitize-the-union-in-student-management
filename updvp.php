...
?>
                        <table id="table">
                            <tr>
                                ...
                                <th>Ngày vi phạm</th>
                                <th>Điểm</th>
                                <th>Thao tác <button type="submit" name="s_submit"><a href='nhapvp.php'>Thêm</a></button></th>
                            </tr>
                            <?php
                                for($i=0;$i<count($arr);$i++){
                                    $line="<tr>
                                            ...
                                            <td>".$arr[$i]["ngay"]."</td>
                                            <td>".$arr[$i]["diem"]."</td>
                                            <td><button type='submit' name='ss_submit'><a href='sua_vp.php?id=".$arr[$i]["id"]."'>Sửa</a>
                                            </button> <button type='submit' name='s_submit'><a href='delvp.php?id=".$arr[$i]["id"]."'>Xóa</a></button></td>
                                             </tr>";
                                    echo($line);
                                }   
                            ?>
