    ...
    <head>
        ...
        <script language="javascript">
            ...
            function simpleTest() {
                ...
                if(a=='admin'){
                    xmlhttp.open("GET","updvp.php?lop="+str1+"&vp="+str2,true);
                }
                else{
                    xmlhttp.open("GET","nguoidung_getvp.php?lop="+str1+"&vp="+str2,true);
                }
                xmlhttp.send();    
                }  
        </script>
                ...
                <div class="center">
                    ...
                    <div class="cent">
                        <div class="ds">
                            ...
                            <select id="select-box-2" name='vp' onchange="simpleTest()">
                                <option value="all">Tất cả</option>
                                <option value="Đi trễ">Đi trễ</option>
                                <option value="Không thuộc bài">Không thuộc bài</option>
                                <option value="Nói chuyện">Nói chuyện</option>
                                <option value="Đánh nhau">Đánh nhau</option>
                                <option value="KT Miệng <5đ">KT Miệng &lt;5đ</option>
                            </select>
                        </div>
                        <div id="F1" class="F"> 
                    </div>
